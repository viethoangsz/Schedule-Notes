...
class _HomeScreenState extends State<HomeScreen> {
      ...
      onResult: (result) {
        ...
        if (result.finalResult) {
          ...
          if (_recognizedText.isNotEmpty) {
            _showVoiceResultSheet(_recognizedText);
          }
        }
      },
      localeId: 'vi_VN',
  ...
  void _openNoteWithText(String text) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => NoteEditorScreen(initialContent: text),
      ),
  ...
  void _openTaskWithText(String text) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => TaskFormScreen(initialTitle: text),
      ),
      ...
      floatingActionButton: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: _isListening
              ? [BoxShadow(color: cs.error.withOpacity(0.4), blurRadius: 20, spreadRadius: 4)]
...
class _QuickActionsSection extends StatelessWidget {
  ...
  const _QuickActionsSection({required this.onVoiceNote, required this.onVoiceTask});
...
class _StatsSection extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Consumer2<TaskProvider, AlarmProvider>(
      builder: (context, taskProvider, alarmProvider, _) {
        ...
        return Padding(
          ...
          child: Row(
            children: [
              ...
              _StatCard(
                label: 'Báo thức',
                value: '${alarmProvider.enabledCount}',
        ...
        leading: GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: task.completed ? AppTheme.priorityLow : cs.outline,
                width: 2,
              ),
            ),
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        ...
                        colors: [
                          cs.primaryContainer,
                          cs.primaryContainer.withBlue(
                            (cs.primaryContainer.blue + 20).clamp(0, 255),
                          ),
                        ],
                      ),
                      borderRadius: BorderRadius.circular(16),
